...
public class Shark : MonoBehaviour
{
    ...
    public Vector3 zone = new Vector3(0, 0, 0);
    ...
    void Awake()
    {
        ...
        zone.y = thisTransform.position.y;
    ...
    void Move()
    {
        ...
        target = new Vector3(target.x, startYpos, target.z);
    ...
    IEnumerator RandomVector()
    {
        ...
        while (true)
        {
            targetRandom = zone + (Random.insideUnitSphere * walkZone);
            yield return delay0;
        }
